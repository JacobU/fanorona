import { PieceType, CellType, Connection, Direction, Neighbour } from "./types.js";
...
export default class Cell {
    ...
    public setNeighbour(direction: Direction, cell: Cell): void {
        this.neighbours.push({ direction, cell });
    }
